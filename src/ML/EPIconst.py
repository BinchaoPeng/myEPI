class EPIconst:
    ...
    class Params:
        ...
        GM12878_eiip_rf = {}
        "----------------------------------------------"
        GM12878_kemr_deepforest = {}
        GM12878_kemr_lightgbm = {}
        GM12878_kemr_svm = {}
        GM12878_kemr_xgboost = {}
        GM12878_kemr_rf = {}
        "----------------------------------------------"
        ...
        "----------------------------------------------"
        HeLa_S3_kemr_deepforest = {}
        HeLa_S3_kemr_lightgbm = {}
        HeLa_S3_kemr_rf = {}
        HeLa_S3_kemr_svm = {}
        HeLa_S3_kemr_xgboost = {}
