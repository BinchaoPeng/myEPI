...
class PseKNC_II:
    ...
    def __call__(self, seq_list: list, case_type="paper_case"):
        ...
        PseKNC_feature = self.run_PseKNC_II(seq_list=seq_list, case_type=case_type)

        return PseKNC_feature

    def get_PseKNC_II(self, seq, case_type="paper_case"):
        """
...
class PseDNC_II(PseKNC_II):
    ...
    def get_PseDNC_II(self, seq, case_type="paper_case"):
        return PseKNC_II.get_PseKNC_II(self, seq, case_type)

    def run_PseDNC_II(self, seq_list: list, case_type="paper_case"):
        PseDNC_II_feature = PseKNC_II.run_PseKNC_II(self, seq_list, case_type)
